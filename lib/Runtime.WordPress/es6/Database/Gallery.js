...
Runtime.WordPress.Database.Gallery = class extends Runtime.ORM.Record
{
	/**
	 * Returns table name
	 */
	static getTableName(){ return "gallery"; }
	...
	static getClassName(){ return "Runtime.WordPress.Database.Gallery"; }
