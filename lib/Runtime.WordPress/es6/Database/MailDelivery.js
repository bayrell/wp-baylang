...
Runtime.WordPress.Database.MailDelivery = function()
{
	Runtime.ORM.Relation.apply(this, arguments);
};
Runtime.WordPress.Database.MailDelivery.prototype = Object.create(Runtime.ORM.Relation.prototype);
Runtime.WordPress.Database.MailDelivery.prototype.constructor = Runtime.WordPress.Database.MailDelivery;
Object.assign(Runtime.WordPress.Database.MailDelivery.prototype,
{
	/**
	 * Save
	 */
...
Object.assign(Runtime.WordPress.Database.MailDelivery, Runtime.ORM.Relation);
Object.assign(Runtime.WordPress.Database.MailDelivery,
{
	/**
     * Returns table name
     */
	...
	schema: function()
	{
		var __memorize_value = Runtime.rtl._memorizeValue("Runtime.WordPress.Database.MailDelivery.schema", arguments);
		...
		Runtime.rtl._memorizeSave("Runtime.WordPress.Database.MailDelivery.schema", arguments, __memorize_value);
...
Runtime.rtl.defClass(Runtime.WordPress.Database.MailDelivery);
window["Runtime.WordPress.Database.MailDelivery"] = Runtime.WordPress.Database.MailDelivery;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Runtime.WordPress.Database.MailDelivery;