...
Runtime.WordPress.Database.ORM.WP_Cursor = function()
{
	Runtime.ORM.MySQL.CursorMySQL.apply(this, arguments);
};
Runtime.WordPress.Database.ORM.WP_Cursor.prototype = Object.create(Runtime.ORM.MySQL.CursorMySQL.prototype);
Runtime.WordPress.Database.ORM.WP_Cursor.prototype.constructor = Runtime.WordPress.Database.ORM.WP_Cursor;
Object.assign(Runtime.WordPress.Database.ORM.WP_Cursor.prototype,
{
	/**
	 * Execute sql query
	 */
...
Object.assign(Runtime.WordPress.Database.ORM.WP_Cursor, Runtime.ORM.MySQL.CursorMySQL);
Object.assign(Runtime.WordPress.Database.ORM.WP_Cursor,
{
...
Runtime.rtl.defClass(Runtime.WordPress.Database.ORM.WP_Cursor);
window["Runtime.WordPress.Database.ORM.WP_Cursor"] = Runtime.WordPress.Database.ORM.WP_Cursor;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Runtime.WordPress.Database.ORM.WP_Cursor;