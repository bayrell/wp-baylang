...
Runtime.WordPress.Database.MailSettings = function()
{
	Runtime.ORM.Relation.apply(this, arguments);
};
Runtime.WordPress.Database.MailSettings.prototype = Object.create(Runtime.ORM.Relation.prototype);
Runtime.WordPress.Database.MailSettings.prototype.constructor = Runtime.WordPress.Database.MailSettings;
Object.assign(Runtime.WordPress.Database.MailSettings.prototype,
{
});
Object.assign(Runtime.WordPress.Database.MailSettings, Runtime.ORM.Relation);
Object.assign(Runtime.WordPress.Database.MailSettings,
{
	/**
     * Returns table name
     */
	...
	schema: function()
	{
		var __memorize_value = Runtime.rtl._memorizeValue("Runtime.WordPress.Database.MailSettings.schema", arguments);
		...
		Runtime.rtl._memorizeSave("Runtime.WordPress.Database.MailSettings.schema", arguments, __memorize_value);
...
Runtime.rtl.defClass(Runtime.WordPress.Database.MailSettings);
window["Runtime.WordPress.Database.MailSettings"] = Runtime.WordPress.Database.MailSettings;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Runtime.WordPress.Database.MailSettings;