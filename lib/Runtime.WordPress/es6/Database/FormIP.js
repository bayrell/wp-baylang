...
Runtime.WordPress.Database.FormIP = class extends Runtime.ORM.Record
{
	/**
	 * Returns table name
	 */
	static getTableName(){ return "forms_ip"; }
	...
	static getClassName(){ return "Runtime.WordPress.Database.FormIP"; }
