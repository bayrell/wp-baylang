...
class MailSettingsPage extends \Runtime\Component
{
	function render()
	{
		...
		/* Element div */
		$__v0 = $__v->element("div", (new \Runtime\Map(["class" => \Runtime\rs::className(new \Runtime\Vector("mail_settings_page", $componentHash))])));
		...
		/* Slot row_buttons */
		$__v1->slot("row_buttons", function ($item, $field, $row_buttons)
		{
			$componentHash = \Runtime\rs::getComponentHash(static::getClassName());
			$__v = new \Runtime\VirtualDom($this);
	...
	static function getRequiredComponents(){ return new \Runtime\Vector("Runtime.Widget.Button", "Runtime.Widget.RowButtons", "Runtime.Widget.Input", "Runtime.Widget.Select", "Runtime.Widget.Table.TableWrap"); }
	static function getClassName(){ return "Runtime.WordPress.Admin.MailSettings.MailSettingsPage"; }
}