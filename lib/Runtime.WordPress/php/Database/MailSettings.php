...
class MailSettings extends \Runtime\ORM\Relation
{
	/**
     * Returns table name
     */
	...
	{
		$__memorize_value = \Runtime\rtl::_memorizeValue("Runtime.WordPress.Database.MailSettings.schema", func_get_args());
		...
		\Runtime\rtl::_memorizeSave("Runtime.WordPress.Database.MailSettings.schema", func_get_args(), $__memorize_value);
