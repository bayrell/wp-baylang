...
Runtime.XML.Test.PatcherRemove = function()
{
};
Object.assign(Runtime.XML.Test.PatcherRemove.prototype,
{
});
Object.assign(Runtime.XML.Test.PatcherRemove,
{
	testRemove1: function()
	{
		var xml = Runtime.XML.XML.loadXml("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n\t\t\t<template>\n\t\t\t\t<yaml>\n\t\t\t\t\t<services>\n\t\t\t\t\t\t<test>\n\t\t\t\t\t\t\t<image>test</image>\n\t\t\t\t\t\t</test>\n\t\t\t\t\t\t<database>\n\t\t\t\t\t\t\t<image>database</image>\n\t\t\t\t\t\t</database>\n\t\t\t\t\t\t<other>\n\t\t\t\t\t\t\t<image>other</image>\n\t\t\t\t\t\t\t<dns>192.168.1.1</dns>\n\t\t\t\t\t\t</other>\n\t\t\t\t\t</services>\n\t\t\t\t</yaml>\n\t\t\t</template>");
		var operation = Runtime.XML.XML.loadXml("<operation type=\"remove\">\n\t\t\t\t<path>/template/yaml/services/database</path>\n\t\t\t</operation>");
		xml.patch(operation);
...
Runtime.rtl.defClass(Runtime.XML.Test.PatcherRemove);
window["Runtime.XML.Test.PatcherRemove"] = Runtime.XML.Test.PatcherRemove;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Runtime.XML.Test.PatcherRemove;