...
Runtime.XML.Test.PatcherRemove = class
{
	...
	static getClassName(){ return "Runtime.XML.Test.PatcherRemove"; }
	static getMethodsList()
	{
		const Vector = use("Runtime.Vector");
		return new Vector("testRemove1");
	}
	static getMethodInfoByName(field_name)
	{
		const Vector = use("Runtime.Vector");
		if (field_name == "testRemove1") return new Vector(
