...
Runtime.XML.Test.PatcherRemoveAttribute = function()
{
};
Object.assign(Runtime.XML.Test.PatcherRemoveAttribute.prototype,
{
});
Object.assign(Runtime.XML.Test.PatcherRemoveAttribute,
{
	testAdd1: function()
	{
		var xml = Runtime.XML.XML.loadXml("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n\t\t\t<root>\n\t\t\t\t<item>1</item>\n\t\t\t\t<item name=\"test\">2</item>\n\t\t\t\t<item>3</item>\n\t\t\t</root>");
		var operation = Runtime.XML.XML.loadXml("<operation type=\"remove_attribute\">\n\t\t\t\t<path>/root/item</path>\n                <name>name</name>\n\t\t\t</operation>");
		xml.patch(operation);
...
Runtime.rtl.defClass(Runtime.XML.Test.PatcherRemoveAttribute);
window["Runtime.XML.Test.PatcherRemoveAttribute"] = Runtime.XML.Test.PatcherRemoveAttribute;
if (typeof module != "undefined" && typeof module.exports != "undefined") module.exports = Runtime.XML.Test.PatcherRemoveAttribute;