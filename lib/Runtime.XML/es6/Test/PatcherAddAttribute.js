...
Runtime.XML.Test.PatcherAddAttribute = class
{
	static testAdd1()
	{
		let xml = Runtime.XML.XML.loadXml("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n\t\t\t<root>\n\t\t\t\t<item>1</item>\n\t\t\t\t<item>2</item>\n\t\t\t\t<item>3</item>\n\t\t\t</root>");
		let operation = Runtime.XML.XML.loadXml("<operation type=\"add_attribute\">\n\t\t\t\t<path>/root/item[2]</path>\n                <name>name</name>\n\t\t\t\t<value>test</value>\n\t\t\t</operation>");
		xml.patch(operation);
	...
	static getClassName(){ return "Runtime.XML.Test.PatcherAddAttribute"; }
