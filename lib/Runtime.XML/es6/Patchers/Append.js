...
Runtime.XML.Patchers.Append = class extends Runtime.XML.BasePatcher
{
	/**
	...
	patch(xml, operation)
	{
		...
		if (!path) return;
		let position = operation.attr("position");
	...
	static getClassName(){ return "Runtime.XML.Patchers.Append"; }
