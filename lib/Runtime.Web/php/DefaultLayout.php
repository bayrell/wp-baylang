...
class DefaultLayout extends \Runtime\Web\Component
{
	function renderCurrentPage()
	{
		...
		$current_page_model = $this->layout->current_page_model;
		...
		if ($current_page)
		{
			if ($current_page_model)
			{
				...
				$this->_c($__v, $current_page, ["model" => $this->_model(\Runtime\Vector::from(["widgets",$current_page_model]))]);
			}
			else
			{
				/* Component '{current_page}' */
				$this->_c($__v, $current_page, []);
			}
		}
