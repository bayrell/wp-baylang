...
Object.assign(Runtime.Web.ApiRoute,
{
	...
	actionIndex: async function(container)
	{
		...
		try
		{
			api_result = await bus.send(Runtime.Map.from({"service":service,"api_name":api_name,"method_name":method_name,"layout":container.layout,"data":container.request.payload.get("data"),"container":container}));
		}
		catch (_ex)
		{
