...
class ConfirmDialog extends \Runtime\Widget\Dialog\Dialog
{
	...
	function renderFooter()
	{
		...
		/* Element Runtime.Widget.Button */
		$__v2 = $__v0->element("Runtime.Widget.Button", (new \Runtime\Map(["class" => \Runtime\rs::className(new \Runtime\Vector("button--primary", $componentHash)), "styles" => $this->model->title_button_styles])));
	...
	static function getComponentStyle(){ return ".dialog__content.h-5497 .result{margin-top: calc(var(--space) * 0.5)}"; }
	static function getRequiredComponents(){ return new \Runtime\Vector("Runtime.Widget.Button"); }
	static function getClassName(){ return "Runtime.Widget.Dialog.ConfirmDialog"; }
}