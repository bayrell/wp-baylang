...
Runtime.Widget.Api.Rules.RequiredRule = class extends Runtime.Widget.Api.Rules.BaseRule
{
	/**
	 * On save before
	 */
	async onSaveBefore(api)
	{
		...
		if (value === "" || value === null)
		{
			...
			error.set(this.field_name, Runtime.Vector.create(["Required"]));
	...
	static getClassName(){ return "Runtime.Widget.Api.Rules.RequiredRule"; }
	static getMethodsList(){ return null; }
	static getMethodInfoByName(field_name){ return null; }
	static getInterfaces(){ return []; }
};
window["Runtime.Widget.Api.Rules.RequiredRule"] = Runtime.Widget.Api.Rules.RequiredRule;