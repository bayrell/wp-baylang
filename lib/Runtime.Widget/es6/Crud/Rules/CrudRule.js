...
Runtime.Widget.Crud.Rules.CrudRule.prototype = Object.create(Runtime.Widget.Crud.Rules.BaseRule.prototype);
...
Object.assign(Runtime.Widget.Crud.Rules.CrudRule.prototype,
{
	 ...
	 * Before search item
	 */
	onSearchBefore: async function(api)
	{
	},
	/**
	 * After search item
	 */
	onSearchAfter: async function(api)
	{
	},
	/**
	 * Before save item
...
Object.assign(Runtime.Widget.Crud.Rules.CrudRule, Runtime.Widget.Crud.Rules.BaseRule);
