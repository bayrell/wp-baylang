...
Runtime.ORM.Exceptions.DuplicateException = class extends Runtime.ORM.Exceptions.OrmException
{
	constructor(message, prev)
	{
		if (message == undefined) message = "";
		if (prev == undefined) prev = null;
		super(message, Runtime.rtl.ERROR_DUPLICATE, prev);
	}
	...
	static getClassName(){ return "Runtime.ORM.Exceptions.DuplicateException"; }
