...
Runtime.ORM.Annotations.TinyIntType = class extends Runtime.ORM.Annotations.BaseType
{
	/**
	 * Returns rule
	 */
	getRule(){ return new Runtime.Serializer.IntegerType(); }
	...
	static getClassName(){ return "Runtime.ORM.Annotations.TinyIntType"; }
