...
Runtime.ORM.Annotations.BaseType = class extends Runtime.ORM.Annotations.BaseStruct
{
	/**
	 * Create object
	 */
	 ...
	 */
	prepare(item, action){ return item; }
	...
	static getClassName(){ return "Runtime.ORM.Annotations.BaseType"; }
