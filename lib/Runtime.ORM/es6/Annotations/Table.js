...
Runtime.ORM.Annotations.Table = function(name)
{
	Runtime.Entity.Entity.call(this, Runtime.Map.from({"name":name}));
};
Runtime.ORM.Annotations.Table.prototype = Object.create(Runtime.Entity.Entity.prototype);
...
Object.assign(Runtime.ORM.Annotations.Table, Runtime.Entity.Entity);
