...
Runtime.ORM.ModuleDescription = class
{
	/**
	 * Returns module name
	 * @return string
	 */
	static getModuleName(){ return "Runtime.ORM"; }
	...
	static entities()
	{
		return Runtime.Vector.create([
			new Runtime.Entity.Provider("Runtime.ORM.Provider", "Runtime.ORM.Provider"),
		]);
	}
	...
	static getClassName(){ return "Runtime.ORM.ModuleDescription"; }
