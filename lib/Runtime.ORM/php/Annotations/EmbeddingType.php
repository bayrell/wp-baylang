...
class EmbeddingType extends \Runtime\ORM\Annotations\BaseType
{
	var $dimension;
	...
	function padding($value)
	{
		...
		if ($count != $this->dimension)
		{
			...
			if ($count < $this->dimension)
			{
				for ($i = 0; $i < $this->dimension - $count; $i++)
				{
					$value->_arr[] = 0;
				}
			}
	...
	static function getClassName(){ return "Runtime.ORM.Annotations.EmbeddingType"; }
