...
use Runtime\Serializer\IntegerType as IntType;
use Runtime\ORM\Annotations\BaseType;
use Runtime\ORM\Connection;


class IntegerType extends \Runtime\ORM\Annotations\BaseType
{
	/**
	 * Returns schema
	 */
	...
	static function getClassName(){ return "Runtime.ORM.Annotations.IntegerType"; }
