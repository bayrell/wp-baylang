...
Runtime.Test.Serialize.Data.PageModel = class extends Runtime.BaseModel
{
	/**
	 * Serialize object
	 */
	static serialize(rules)
	{
		...
		rules.addType("user", new Runtime.Serializer.ObjectType(Runtime.Map.create({
	...
	initWidget(params)
	{
		...
		this.table = this.createWidget("Runtime.Widget.Table.TableModel", Runtime.Map.create({
			"component": "App.Table",
		}));
	}
	...
	static getClassName(){ return "Runtime.Test.Serialize.Data.PageModel"; }
	static getMethodsList(){ return null; }
	static getMethodInfoByName(field_name){ return null; }
	static getInterfaces(){ return []; }
};
window["Runtime.Test.Serialize.Data.PageModel"] = Runtime.Test.Serialize.Data.PageModel;