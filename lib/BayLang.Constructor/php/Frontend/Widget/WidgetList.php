...
class WidgetList extends \Runtime\Web\Component
{
	function render()
	{
		...
		/* Component 'Table' */
		$this->_c($__v0, "Runtime.Widget.Table.Table", ["model" => $this->_model($this->model->table),"class" => $this->_class_name(["widgets_table"])]);
		
		/* Element 'div' */
		$this->_e($__v, "div", ["class" => $this->_class_name(["widgets_list"])], $__v0);
