...
class WidgetService extends \Runtime\Widget\Crud\CrudService
{
	public $module;
	public $project;
	public $assets_path;
	...
	{
		/* Get data */
		$data = \Runtime\Map::from(["id"=>$item->name,"module_id"=>$item->module->getName()]);
	...
	{
		/* Get widgets */
		$this->items = $this->project->modules->transition(function ($module)
		{
			return $module;
		})->map(function ($module)
		{
	...
	function saveFile($file_path, $base64_content)
	{
		...
		/* Compile file */
		$relative_src_file_path = $this->module->getRelativeSourcePath($file_path);
